...
class TestBooksCollector:
    ...
    def test_add_new_book_not_add_if_name_too_long(self,collector):
        long_name = "А" * 45
        collector.add_new_book(long_name)

        assert len(collector.get_books_genre()) == 0 #проверка добавления книги

    def test_add_new_book_not_add_if_duplicate(self,collector):
        collector.add_new_book("Книга")
        collector.add_new_book("Книга")
        assert len(collector.get_books_genre()) == 1

    def test_new_book_added_without_genre(self,collector):
        collector.add_new_book("Книга")
        assert collector.get_book_genre("Книга") == ""

    @pytest.mark.parametrize("genre", ["Фантастика", "Комедии"])
    def test_set_book_genre_success(self,collector, genre):
        collector.add_new_book("Книга")
        collector.set_book_genre("Книга", genre)

        assert collector.get_book_genre("Книга") == genre

    def test_set_book_genre_fail_if_genre_invalid(self,collector):
        collector.add_new_book("Книга")
        collector.set_book_genre("Книга", "Поэзия")

        assert collector.get_book_genre("Книга") == ""

    def test_get_books_with_specific_genre_return_books(self,collector):
    ...
    def test_add_book_in_favorites_and_delete(self,collector):
        collector.add_new_book("Книга")
    ...
    def test_get_books_genre_returns_dict_of_books(self, collector):
        collector.add_new_book("Книга1")
        collector.add_new_book("Книга2")
